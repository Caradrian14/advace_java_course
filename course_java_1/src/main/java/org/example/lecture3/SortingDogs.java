...
//        Collections.sort(dogList);
    ...
    public static void comparator(DogClass[] dogArray){
        // sorts ascending by age
//        Comparator<DogClass> byAge = Comparator.comparing(dog -> dog.getAge());
//        Arrays.sort(dogArray, byAge);
//        System.out.println(Arrays.toString(dogArray));// [Dog{name=Spot, age=2}, Dog{name=Rover, age=7}]

//        Comparator<DogClass> byAgeReversed = Comparator.comparing(DogClass::getAge).reversed();
//        Arrays.sort(dogArray, byAgeReversed);
        System.out.println(Arrays.toString(dogArray));// [Dog{name=Rover, age=7}, Dog{name=Spot, age=2}]
    }
    public static void comparator(List<DogClass> dogList){
        // sorts ascending by age
//        Comparator<DogClass> byAge = Comparator.comparing(DogClass::getAge);
