...
class DogClass2{
    ...
    DogClass2(String name){this.name = name;}
    public void setName(String name) {this.name = name;}

    @Override
    public boolean equals(Object obj){
        if(obj instanceof DogClass2){
            DogClass2 otherDog = (DogClass2)obj;
...
public class MutableFieldsTest {
    public static void main(String[] args) {
        ...
        DogClass2 spot                = new DogClass2("Spot");
        Map<DogClass2, String> dogs   = new HashMap<>();
