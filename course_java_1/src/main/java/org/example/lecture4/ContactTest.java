...
class ContactClass {
    ...
    ContactClass(String name, int age) {
        this.age  = age;
        this.name = name;
    }
    @Override
...
public class ContactTest {
    private static Map<ContactClass, String> map = new HashMap<>();
    public static void main(String args[]) {
        ContactClass john  = new ContactClass("john", 33);
        ContactClass peter = new ContactClass("peter",34);
        ...
        ContactClass mary = new ContactClass("mary", 21);
    ...
    public static void otherScope(){
        ContactClass anotherMary = new ContactClass("mary", 21);// reconstruct "anotherMary"
    ...
    public static void testJane(){
        ...
        ContactClass jane = new ContactClass("jane", 21);
